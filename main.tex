...
\setup{title={PePSA: A Privacy-enhancing Proxy for Solid Applications},
  author={Jesse Geens},
...
\setup{filingcard,
  translatedtitle={Een privacy-verbeterende proxy voor Solid applicaties},
  udc=621.3,
...
\newenvironment{futurework}[1][]{\refstepcounter{futurework}\par\medskip
   \noindent \textbf{Future Work~\thefuturework #1} \rmfamily}{\medskip}
...
\appendix
\include{appendices/schemas/schemas}
...
\nocite{*}
\bibliography{bibliography/intro, bibliography/solid, bibliography/pets, bibliography/middleware}
